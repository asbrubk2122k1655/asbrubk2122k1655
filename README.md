...
<body>
    <header>
        <div class="header-content">
            ...
            <img src="C:\Users\Admin\Downloads\1679632621487.jpg" alt="Your Profile Picture" class="profile-picture">
            <h1>PRIYANKA BHARATHI.B</h1>
            <p>STUDENT</p>
        </div>
    </header>
    ...
    <section id="resume">
        ...
        <div class="section-content">
            <center>
            <h2>Resume</h2>
            <a href="https://docs.google.com/document/d/1HG-fSgracugNUSdTiqIyeVdOAwxm8KtFwDquUmaQ6ZQ/edit?usp=drive_link" target="_blank" class="download-button">Download CV</a>
        </center>
        </div>
    ...
    <footer>
        <p>&copy; 2023 priyanka bharathi.B</p>
    </footer>
